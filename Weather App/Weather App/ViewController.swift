...
class ViewController: UIViewController {
    ...
    private var city = City(lat: "-25.3903", lon: "-51.4554", name: "Guarapuava")
    ...
    private func setConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            dailyForecastTableView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 15),
            dailyForecastTableView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -15),
